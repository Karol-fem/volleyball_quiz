...
if (sorted_answs[0] == answs[0] ) {
            ...
            else if (sorted_answs[0] == answs[1]) {
                result.innerHTML = '<img src="imgs/libero.jpg"><div class="descript"><h2>Либеро</h2><p>Для игрока в амплуа «либеро» в волейболе важны как физические, так и психологические качества. Либеро — специальный игрок, выполняющий только защитные функции: приём атакующих ударов соперника, подбор отскоков от блока и сбросов. Его главная задача — удерживать мяч в игре после атак соперника, обеспечивая команде возможность построить контратаку. Вы обладаете интуицией, умением положительно влиять на психологический климат окружающих, всегда поможете друзьям в трудную минуту.</p> </div>';
            }
            else if (sorted_answs[0] == answs[2]) {
            ...
            else result.innerHTML = "<img src='imgs/attack.jpg'><div class=\"descript\"><h2>Атакующий</h2><p>Бомбер, ориентированный на результат Вы - быстрый, ловкий и уравновещенный игрок. В сложных ситуациях нападающий способен сохранять хладнокровность и добиваться результата несмотря на хаос вокруг.</p></div>";
})
